...
import 'package:house_an_apartement/screen/house_details.dart';
...
class _AllPostState extends State<AllPost> {
  ...
  void initState() {
    super.initState();
    _stream =
        FirebaseFirestore.instance.collection('house_details').snapshots();
  }
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Find apartment by location',
                ...
                if (snapshot.hasData) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final postUserID = filteredDocs[index]['userId'];
                        return Dismissible(
                          key: UniqueKey(),
